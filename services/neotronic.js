/**
* @description REST Api for the Neotronic team
...
mongo.MongoClient.connect(uristring, function(err, database) {
    if(!err) {
        db = database;
        console.log('Neotronic Team Connected to the "Hardwarethon_Database" database');
    }
    else{
        console.log(404, 'Neotronic Team Error Connecting to the "Hardwarethon_Database" database');
    }
});
